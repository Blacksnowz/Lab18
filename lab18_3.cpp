...
int main() {
    ...
    while (getline(course_file, textline)) {
        if (state == 1) {
            ...
            getline(course_file, textline);  // Read the next line (which might be lecturers or students)
            ...
            if (textline == "> Students") {
                ...
                // Append textline to lecture_list[] of the recently added course
            ...
            if (textline == "---------------------------------------") {
                ...
                // Find student by ID and append the pointer to student_list of the recently added course
